...
export default function ModalEliminarTarea() {
  const {handleModalEliminarTarea,ModalEliminarTarea,eliminarTarea,alerta} = useProyectos();
  ...
  return (
    <>
      ...
      <Transition appear show={ModalEliminarTarea} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={handleModalEliminarTarea}>
          <Transition.Child
            as={Fragment}
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mx-6 text-gray-500">
                        <p>Una tarea eliminada no se podrá recuperar</p>
                    </div>
